document.addEventListener("DOMContentLoaded", () => {
  const availableCards = [
    {
      id: 0,
      image: "our-school.png",
      text: "OUR SCHOOL",
      translate: "NOSSA ESCOLA",
      sound: "our-school"
    },
    {
      id: 1,
      image: "stay-home.png",
      text: "STAY HOME",
      translate: "FIQUE EM CASA",
      sound: "stay-home"
    },
    {
      id: 2,
      image: "wash-your-hands.png",
      text: "WASH YOUR HANDS",
      translate: "LAVE SUAS MÃOS",
      sound: "wash-your-hands"
  ...
  availableCards.forEach(card => {
    if(card.sound) {
      sounds[card.sound] = new Audio(`sounds/${card.sound}.mp3`);
    }
  })  
